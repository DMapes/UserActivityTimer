...
mouse_ex = threading.Thread(target = add_time(ms_track_time(datetime.datetime.now())))
keyboard_ex = threading.Thread(target = add_time(kb_track_time(datetime.datetime.now())))
